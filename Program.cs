...
namespace JfkInitializer
{
    class Program
    {
        ...
        private static readonly AzureKeyCredential credentials = new AzureKeyCredential("9f6060e9beda407899ca3df8cbd25262");
        private static readonly Uri endpoint = new Uri("https://meps-sentiments.cognitiveservices.azure.com/");
